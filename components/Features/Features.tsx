      ...
      <Container size="lg">
        ...
        >
          ...
          <Text className={classes.description}>
            AAMA.io specializes in mutual fund management, leveraging our deep expertise in regulated fund operations
            to deliver a comprehensive platform that meets the highest standards of compliance and efficiency.
            Our solution streamlines mutual fund operations, enhances transparency, and enables new investment models
        ...
        <Box mt={50}>
          <Paper withBorder p="xl" radius="lg" className={classes.overviewPaper}>
            ...
            <Title order={2} className={classes.paperTitle} mb="xl">Expertise in Mutual Fund Management</Title>
            <Text size="lg" mb="xl">
              With proven experience in managing live mutual funds, AAMA.io understands the unique challenges
              and regulatory requirements of mutual fund operations. Our platform combines traditional fund
              management expertise with modern technology to deliver a robust solution that meets the highest
              standards of compliance, efficiency, and investor service. We've successfully deployed mutual
              funds that adhere to strict regulatory frameworks, making us a trusted partner for fund managers
              seeking excellence in mutual fund operations.
            </Text>
            ...
            <SimpleGrid cols={{ base: 1, md: 2 }} spacing="xl">
              <Stack className={classes.featureBlock}>
                ...
                <Text>
                  Our platform is built specifically for mutual fund operations, with comprehensive support for
              ...
              <Stack className={classes.featureBlock}>
                ...
                <Text>
                  We provide a complete investor servicing solution for mutual funds, including automated
        ...
        <Box mt={60}>
          <Title order={2} className={classes.sectionTitle} ta="center" mb={40}>
            Mutual Fund <span className={classes.highlight}>Capabilities</span>
          </Title>
            ...
            >
              <Paper withBorder p="xl" radius="lg" h="100%" className={classes.card}>
                <div className={classes.cardInner}>
                  ...
                  <Text mt="sm">
                    Comprehensive mutual fund operations including daily NAV calculations, unit pricing,
            ...
            >
              <Paper withBorder p="xl" radius="lg" h="100%" className={classes.card}>
                <div className={classes.cardInner}>
                  ...
                  <Text mt="sm">
                    End-to-end mutual fund investor servicing including subscription processing,
          ...
          <Box mt={60} mb={30}>
            <Paper withBorder p="xl" radius="lg" className={classes.futureSection}>
              ...
              <Text ta="center" size="lg" px={{ base: 0, md: 80 }} mb="xl">
                AAMA.io is not just a mutual fund management platform—it's a vision for the future of regulated fund operations.
                We're building the infrastructure that will power the next generation of mutual funds, making them more
                efficient, transparent, and accessible while maintaining the highest standards of regulatory compliance.
                Our platform combines proven mutual fund expertise with modern technology to create a new standard
                for fund management.
              </Text>
